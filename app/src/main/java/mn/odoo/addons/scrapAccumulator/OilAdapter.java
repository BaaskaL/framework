...
public class OilAdapter extends RecyclerView.Adapter<OilAdapter.MyViewHolder> {
    ...
    private List<TechnicOil> albumList;
    ...
    public OilAdapter(Context mContext, List<TechnicOil> albumList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout._my_scrap_oil_oil_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        TechnicOil album = albumList.get(position);
        holder.title.setText("nananamaa");
        holder.count.setText(111 + " songs");
